...
const REditad_success = ({User,navigation,Token,route}) => {
...
<View>
   ...
   <Text style={styles.errorText}>Successfully edited your Ad</Text>
...
const mapDispatchToProps = (dispatch) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(REditad_success);
