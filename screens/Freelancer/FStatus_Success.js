...
const FStatus_Success = ({User,navigation,Token,route}) => {

    return(

<View>
   <View  style={styles.headerStyle}>
    <Text style={styles.errorText}>Status Changed Successfully</Text>
    </View>
</View>
...
const mapDispatchToProps = (dispatch) => {
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(FStatus_Success);
